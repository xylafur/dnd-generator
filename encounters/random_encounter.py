...
from encounters.random_encounter_tables import tables_manifest
from lib.random_die import roll_d20
from util.util import average_die

def generate_creatre_encounter(terrain, difficulty, *args, **kwargs):
    pass

def generate_treasure_encounter(*args, **kwargs):
    """ Not sure what kind of params this needs
    """
    pass

def generate_character_encounter(*args, **kwargs):
    """ Not sure what kind of params this needs
    """
    pass

def generate_weather_engounter(*args, **kwargs):
    pass
